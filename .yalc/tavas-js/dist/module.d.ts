...
interface PostHogConfig {
    ...
    cookie_name: string;
    loaded: (posthog_instance: Tavas) => void;
...
declare enum InterstitialStatus {
    DRAFT = "DRAFT",
    ACTIVE = "ACTIVE",
    COMPLETED = "COMPLETED",
    DELETE = "DELETE"
...
declare enum InterstitialButtonTypes {
    NA = "NA",
    IN_APP = "IN_APP",
    LINK = "LINK",
...
interface InterstitialButtonAction {
    android: string;
    ios: string;
    web: string;
}
interface InterstitialButtonPayload {
    title?: string;
    body?: string;
    image?: string;
    linkURL?: string;
...
interface InterstitialPopupResponse {
...
declare class Tavas {
    ...
    actionsObservable: BehaviorSubject<any>;
    popupConfig: InAppPopupConfig | null;
    constructor();
    /**
     ...
     */
    init(token: string, config?: Partial<PostHogConfig>, name?: string): Tavas | void;
     ...
     * ----------------------------------------------------------------
     */
    interstitialPopupCallback(buttonData: InterstitialButton): void;
    /**
     * Show Interstitial popup
     * @param {InAppPopupConfig} popupConfig
     * ----------------------------------------------------------------
     */
    showInterstitialPopup(popupConfig?: InAppPopupConfig): Observable<any>;
    /**
     ...
     * ----------------------------------------------------------------
     */
    dismissInterstitialPopup(wrapperId: string, overlayId: string): void;
    /**
     * Creates a basic popup
     * ----------------------------------------------------------------
     */
    createBasicPopup(): any;
    /**
     ...
     * ----------------------------------------------------------------
     */
    createDialogFcmPopup(data: InterstitialButton): void;
    /**
     ...
     * ----------------------------------------------------------------
     */
    createInterstitialPopup(popupData: InterstitialPopupResponse[]): void;
    /**
     ...
     * ----------------------------------------------------------------
     */
    createInterstitialPopupButton(buttonsData: InterstitialButton): HTMLButtonElement;
    /**
     ...
     * ----------------------------------------------------------------
     */
    createInterstitialPopupButtons(popupResponse: InterstitialPopupResponse): HTMLButtonElement[];
}

declare const tavas: Tavas;

export { AutoCaptureCustomProperty, AutocaptureCompatibleElement, AutocaptureConfig, Breaker, CaptureCallback, CaptureOptions, CaptureResult, Compression, CompressionData, DecideResponse, DomAutocaptureEvents, EventHandler, FeatureFlagsCallback, GDPROptions, JSC, OptInOutCapturingOptions, PersistentStore, PostData, PostHogConfig, Properties, Property, QueuedRequestData, RequestCallback, RetryQueueElement, SessionRecordingOptions, SnippetArrayItem, Tavas, ToolbarParams, ToolbarSource, ToolbarUserIntent, ToolbarVersion, XHROptions, XHRParams, tavas as default, isFeatureEnabledOptions, tavas };
