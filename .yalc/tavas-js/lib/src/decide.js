...
var Decide = /** @class */ (function () {
    ...
    Decide.prototype.call = function () {
        ...
        */
        ...
        this.instance._send_request("".concat(this.instance.get_config('api_host'), "/decide/?v=2"), { data: encoded_data, verbose: true }, { method: 'POST' }, function (response) { return _this.parseDecideResponse(response); });
    };
