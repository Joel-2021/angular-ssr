...
export declare function userOptedOut(posthog: Tavas, silenceErrors: boolean | undefined): boolean;
/**
 ...
 */
export declare function addOptOutCheck<M extends (...args: any[]) => any = (...args: any[]) => any>(posthog: Tavas, method: M, silenceErrors?: boolean): M;
