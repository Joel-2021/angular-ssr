...
import { CaptureOptions, CaptureResult, Compression, ToolbarParams, GDPROptions, isFeatureEnabledOptions, JSC, OptInOutCapturingOptions, PostHogConfig, Properties, Property, RequestCallback, SnippetArrayItem, XHROptions, AutocaptureConfig } from './types';
import { SentryIntegration } from './extensions/sentry-integration';
import { PageViewIdManager } from './page-view-id';
import { InterstitialPopupResponse, InterstitialButton } from './models/interstitial-dialog-response';
import { BehaviorSubject, Observable } from 'rxjs';
import { InAppPopupConfig } from './models/in-app-popup-config';
/**
 * Tavas Library Object
 * @constructor
 */
export declare class Tavas {
    __loaded: boolean;
...
export declare function init_as_module(): Tavas;
