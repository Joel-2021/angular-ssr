...
import { InterstitialButtonTypes } from './models/enums/interstitial-button-types';
import { BehaviorSubject } from 'rxjs';
import { interstitialPopupStyles } from './models/interstitial-popup-styles';
import { InAppPopupIds } from './models/enums/in-app-popup-ids';
import { InAppDialogEvents } from './models/in-app-dialog-event';
/*
SIMPLE STYLE GUIDE:
 ...
 * @constructor
 */
var Tavas = /** @class */ (function () {
    function Tavas() {
        var _this = this;
        // for in-app popup
        this.actionsObservable = new BehaviorSubject(null);
     ...
     */
    Tavas.prototype.init = function (token, config, name) {
    ...
    //
    Tavas.prototype._init = function (token, config, name) {
        var _a, _b, _c;
        ...
        if (this._hasBootstrappedFeatureFlags()) {
            var activeFlags = Object.keys(((_c = config.bootstrap) === null || _c === void 0 ? void 0 : _c.featureFlags) || {})
    ...
    // Private methods
    Tavas.prototype._loaded = function () {
    ...
    Tavas.prototype._start_queue_if_opted_in = function () {
    ...
    Tavas.prototype._dom_loaded = function () {
        var _this = this;
        if (!this.has_opted_out_capturing()) {
    ...
    Tavas.prototype._prepare_callback = function (callback, data) {
    ...
    Tavas.prototype._handle_unload = function () {
        if (!this.get_config('request_batching')) {
    ...
    Tavas.prototype._handle_queued_event = function (url, data, options) {
        var jsonData = JSON.stringify(data);
        this.__compress_and_send_json_request(url, jsonData, options || __NOOPTIONS, __NOOP);
    };
    Tavas.prototype.__compress_and_send_json_request = function (url, jsonData, options, callback) {
    ...
    Tavas.prototype._send_request = function (url, data, options, callback) {
        var _a;
        if (ENQUEUE_REQUESTS) {
     ...
     * @param {Array} array
     */
    Tavas.prototype._execute_array = function (array) {
        var _this = this;
        var fn_name;
        var alias_calls = [];
        var other_calls = [];
    ...
    Tavas.prototype._hasBootstrappedFeatureFlags = function () {
        var _a, _b;
     ...
     */
    Tavas.prototype.push = function (item) {
     ...
     */
    Tavas.prototype.capture = function (event_name, properties, options) {
    ...
    Tavas.prototype._addCaptureHook = function (callback) {
        this.__captureHooks.push(callback);
    };
    Tavas.prototype._invokeCaptureHooks = function (eventName, eventData) {
        this.config._onCapture(eventName, eventData);
        _each(this.__captureHooks, function (callback) { return callback(eventName); });
    };
    Tavas.prototype._calculate_event_properties = function (event_name, event_properties) {
        var _a;
        // set defaults
     ...
     */
    Tavas.prototype.register = function (properties, days) {
     ...
     */
    Tavas.prototype.register_once = function (properties, default_value, days) {
     ...
     */
    Tavas.prototype.unregister = function (property) {
        this.persistence.unregister(property);
    };
    Tavas.prototype._register_single = function (prop, value) {
        var _a;
     ...
     */
    Tavas.prototype.getFeatureFlag = function (key, options) {
     ...
     * @param {Object|String} options (optional) If {send_event: false}, we won't send an $feature_flag_call event to Tavas.
     */
    Tavas.prototype.isFeatureEnabled = function (key, options) {
        return this.featureFlags.isFeatureEnabled(key, options);
    };
    Tavas.prototype.reloadFeatureFlags = function () {
     ...
     */
    Tavas.prototype.onFeatureFlags = function (callback) {
     ...
     */
    Tavas.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
     ...
     */
    Tavas.prototype.group = function (groupType, groupKey, groupPropertiesToSet) {
        var _a;
     ...
     */
    Tavas.prototype.resetGroups = function () {
     ...
     */
    Tavas.prototype.reset = function (reset_device_id) {
     ...
     *     });
     */
    Tavas.prototype.get_distinct_id = function () {
        return this.get_property('distinct_id');
    };
    Tavas.prototype.getGroups = function () {
     ...
     */
    Tavas.prototype.alias = function (alias, original) {
     ...
     */
    Tavas.prototype.set_config = function (config) {
     ...
     */
    Tavas.prototype.startSessionRecording = function () {
     ...
     */
    Tavas.prototype.stopSessionRecording = function () {
     ...
     */
    Tavas.prototype.sessionRecordingStarted = function () {
        var _a;
     ...
     * @param toolbarParams
     */
    Tavas.prototype.loadToolbar = function (params) {
        return this.toolbar.loadToolbar(params);
    };
    /**
     * returns the current config object for the library.
     */
    Tavas.prototype.get_config = function (prop_name) {
        var _a;
     ...
     */
    Tavas.prototype.get_property = function (property_name) {
        var _a;
        return (_a = this.persistence) === null || _a === void 0 ? void 0 : _a.props[property_name];
    };
    Tavas.prototype.toString = function () {
        var _a;
    ...
    Tavas.prototype._gdpr_init = function () {
     ...
     */
    Tavas.prototype._gdpr_update_persistence = function (options) {
        var disabled;
    ...
    Tavas.prototype._gdpr_call_func = function (func, options) {
        options = _extend({
     ...
     */
    Tavas.prototype.opt_in_capturing = function (options) {
        options = _extend({
     ...
     * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this PostHog instance's config)
     */
    Tavas.prototype.opt_out_capturing = function (options) {
     ...
     */
    Tavas.prototype.has_opted_in_capturing = function (options) {
     ...
     */
    Tavas.prototype.has_opted_out_capturing = function (options) {
     ...
     * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this PostHog instance's config)
     */
    Tavas.prototype.clear_opt_in_out_capturing = function (options) {
        var _options = _extend({
            enable_persistence: true,
    ...
    Tavas.prototype.debug = function (debug) {
        if (debug === false) {
            ...
            window.console.log("You're now in debug mode. All calls to Tavas will be logged in your console.\nYou can disable this with `posthog.debug(false)`.");
            localStorage && localStorage.setItem('ph_debug', 'true');
            this.set_config({ debug: true });
        }
    };
    Tavas.prototype.decodeLZ64 = function (input) {
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.interstitialPopupCallback = function (buttonData) {
        ...
        switch (buttonData.type) {
            ...
            case InterstitialButtonTypes.LINK:
                window.open(((_a = buttonData === null || buttonData === void 0 ? void 0 : buttonData.payload) === null || _a === void 0 ? void 0 : _a.linkURL) || '');
                break;
            case InterstitialButtonTypes.MEDIA_FCM_V2:
                location.replace("".concat(urlOrigin, "/media/").concat((_b = buttonData === null || buttonData === void 0 ? void 0 : buttonData.payload) === null || _b === void 0 ? void 0 : _b.mediaId));
                break;
            case InterstitialButtonTypes.VIEW_UI_CATEGORY:
                location.replace("".concat(urlOrigin, "/category-browse/").concat((_c = buttonData === null || buttonData === void 0 ? void 0 : buttonData.payload) === null || _c === void 0 ? void 0 : _c.uiCategorySlug));
                break;
            case InterstitialButtonTypes.SUBSCRIPTION_LANDING:
                location.replace("".concat(urlOrigin, "/home/").concat((_d = buttonData === null || buttonData === void 0 ? void 0 : buttonData.payload) === null || _d === void 0 ? void 0 : _d.canvasCode));
                break;
            ...
            case InterstitialButtonTypes.TAB_LANDING:
                location.replace("".concat(urlOrigin, "/home/").concat((_e = buttonData === null || buttonData === void 0 ? void 0 : buttonData.payload) === null || _e === void 0 ? void 0 : _e.canvasCode));
                break;
            case InterstitialButtonTypes.IN_APP:
                location.replace("".concat(urlOrigin).concat((_f = buttonData === null || buttonData === void 0 ? void 0 : buttonData.actions) === null || _f === void 0 ? void 0 : _f.web));
                break;
            case InterstitialButtonTypes.OPEN_SIDE_MENU:
                this.actionsObservable.next({ action: 'sidebar', data: true });
                break;
        }
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.showInterstitialPopup = function (popupConfig) {
        var _this = this;
        ...
        fetch("".concat(this.get_config('api_host'), "/tavasCoreV1Campaigns/getMyInAppCampaigns/").concat(this.get_distinct_id()), {
            ...
            _this.createInterstitialPopup(jsonRes);
        })
            .catch(function (err) {
            console.error(err);
            _this.actionsObservable.next({ action: 'onError', data: err });
        });
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.dismissInterstitialPopup = function (wrapperId, overlayId) {
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.createBasicPopup = function () {
        var _a, _b, _c, _d;
        // main wrapper
        var dialogWrapper = document.createElement('div');
        dialogWrapper.setAttribute('style', "".concat(interstitialPopupStyles === null || interstitialPopupStyles === void 0 ? void 0 : interstitialPopupStyles.card, " background: ").concat((_b = (_a = this.popupConfig) === null || _a === void 0 ? void 0 : _a.popupBg) !== null && _b !== void 0 ? _b : '#272635'));
        // overlay
        var overlay = document.createElement('div');
        overlay.setAttribute('style', interstitialPopupStyles.overlay);
        // card header
        ...
        closeBtn.innerHTML = "\n        <svg fill=\"none\" height=\"40\" viewBox=\"0 0 24 24\" width=\"40\" xmlns=\"http://www.w3.org/2000/svg\">\n            <path fill=".concat((_d = (_c = this.popupConfig) === null || _c === void 0 ? void 0 : _c.closeBtnBg) !== null && _d !== void 0 ? _d : '#ffb703', " d=\"m12 2c-5.5102 0-10 4.4898-10 10s4.4898 10 10 10 10-4.4898 10-10-4.4898-10-10-10zm2.551 11.5306c.3061.3061.3061.8163 0 1.1225-.2041.102-.3061.204-.5102.204s-.4081-.102-.5102-.204l-1.5306-1.5306-1.5306 1.5306c-.3061.3061-.81634.3061-1.12246 0-.30612-.3062-.30612-.8164 0-1.1225l1.53066-1.5306-1.53066-1.5306c-.30612-.3061-.30612-.81634 0-1.12246s.81636-.30612 1.12246 0l1.5306 1.53066 1.5306-1.53066c.3061-.30612.8163-.30612 1.1225 0 .3061.30612.3061.81636 0 1.12246l-1.5306 1.5306z\"\n             />\n        </svg>");
        closeBtn.setAttribute('style', interstitialPopupStyles.closeBtn);
        cardHeader.append(titleContainer, closeBtn);
        // Card body
        var cardBody = document.createElement('div');
        cardBody.setAttribute('style', interstitialPopupStyles.cardBody);
        // image
        var cardImg = document.createElement('img');
        cardImg.setAttribute('style', interstitialPopupStyles.cardImage);
        // description
        var cardDescription = document.createElement('p');
        cardDescription.setAttribute('style', interstitialPopupStyles.cardDescription);
        // actions
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.createDialogFcmPopup = function (data) {
        var _this = this;
        var _a, _b, _c;
        var _d = this.createBasicPopup(), dialogWrapper = _d.dialogWrapper, overlay = _d.overlay, cardTitle = _d.cardTitle, cardImg = _d.cardImg, cardActions = _d.cardActions, cardDescription = _d.cardDescription, closeBtn = _d.closeBtn;
        dialogWrapper.id = InAppPopupIds.DIALOG_FCM_POPUP;
        overlay.id = InAppPopupIds.DIALOG_FCM_OVERLAY;
        cardTitle.textContent = ((_a = data === null || data === void 0 ? void 0 : data.payload) === null || _a === void 0 ? void 0 : _a.title) || '---';
        cardImg.src = ((_b = data === null || data === void 0 ? void 0 : data.payload) === null || _b === void 0 ? void 0 : _b.image) || '';
        cardDescription.textContent = ((_c = data === null || data === void 0 ? void 0 : data.payload) === null || _c === void 0 ? void 0 : _c.body) || '---';
        var btnDismiss = this.createInterstitialPopupButton(data);
        btnDismiss.textContent = 'Dismiss';
        var dismissPopup = function () {
            _this.dismissInterstitialPopup(InAppPopupIds.DIALOG_FCM_POPUP, InAppPopupIds.DIALOG_FCM_OVERLAY);
        };
        btnDismiss.addEventListener('click', dismissPopup);
        closeBtn.addEventListener('click', dismissPopup);
        cardActions.append(btnDismiss);
        document.body.append(overlay, dialogWrapper);
    };
    /**
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.createInterstitialPopup = function (popupData) {
        var _this = this;
        var _a, _b, _c, _d;
        if (popupData && popupData.length) {
            var popupResponse_1 = popupData[0];
            var campaignId = localStorage.getItem(popupResponse_1.campaign_id);
            if (popupResponse_1 && campaignId == null) {
                localStorage.setItem(popupResponse_1.campaign_id, 'true');
                var _e = this.createBasicPopup(), dialogWrapper = _e.dialogWrapper, overlay = _e.overlay, cardTitle = _e.cardTitle, cardSubTitle = _e.cardSubTitle, cardImg = _e.cardImg, cardActions = _e.cardActions, cardDescription = _e.cardDescription, closeBtn = _e.closeBtn;
                dialogWrapper.id = InAppPopupIds.IN_APP_POPUP;
                overlay.id = InAppPopupIds.IN_APP_POPUP_OVERLAY;
                cardTitle.textContent = ((_a = popupResponse_1 === null || popupResponse_1 === void 0 ? void 0 : popupResponse_1.campaignData) === null || _a === void 0 ? void 0 : _a.title) || '---';
                cardSubTitle.textContent = ((_b = popupResponse_1 === null || popupResponse_1 === void 0 ? void 0 : popupResponse_1.campaignData) === null || _b === void 0 ? void 0 : _b.subTitle) || '---';
                closeBtn.addEventListener('click', function () {
                    _this.capture('InApp Dialog Closed', new InAppDialogEvents(popupResponse_1.campaign_id, popupResponse_1.campaign_name, popupResponse_1.cohort_id, popupResponse_1.startTime, popupResponse_1.endTime));
                    _this.dismissInterstitialPopup(InAppPopupIds.IN_APP_POPUP, InAppPopupIds.IN_APP_POPUP_OVERLAY);
                });
                cardImg.src = (_c = popupResponse_1 === null || popupResponse_1 === void 0 ? void 0 : popupResponse_1.campaignData) === null || _c === void 0 ? void 0 : _c.imageUrl;
                cardDescription.textContent = ((_d = popupResponse_1 === null || popupResponse_1 === void 0 ? void 0 : popupResponse_1.campaignData) === null || _d === void 0 ? void 0 : _d.description) || '---';
                cardActions.append.apply(cardActions, __spreadArray([], __read(this.createInterstitialPopupButtons(popupResponse_1)), false));
                document.body.append(overlay, dialogWrapper);
                this.actionsObservable.next({ action: 'popupRender', data: popupData });
                this.capture('InApp Dialog Shown', new InAppDialogEvents(popupResponse_1.campaign_id, popupResponse_1.campaign_name, popupResponse_1.cohort_id, popupResponse_1.startTime, popupResponse_1.endTime));
            }
        }
    };
    /**
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.createInterstitialPopupButton = function (buttonsData) {
     ...
     * ----------------------------------------------------------------
     */
    Tavas.prototype.createInterstitialPopupButtons = function (popupResponse) {
        var _this = this;
        var _a, _b;
        var buttons = [];
        (_b = (_a = popupResponse === null || popupResponse === void 0 ? void 0 : popupResponse.campaignData) === null || _a === void 0 ? void 0 : _a.buttons) === null || _b === void 0 ? void 0 : _b.forEach(function (btn) {
            if (btn.type !== InterstitialButtonTypes.RATE_NOW_FCM &&
                btn.type !== InterstitialButtonTypes.DOWNLOADS_PAGE) {
                var adBtn = _this.createInterstitialPopupButton(btn);
                adBtn.addEventListener('click', function () {
                    _this.capture('InApp Dialog CTA Clicked', __assign(__assign({}, new InAppDialogEvents(popupResponse.campaign_id, popupResponse.campaign_name, popupResponse.cohort_id, popupResponse.startTime, popupResponse.endTime)), { ctaTitle: btn.title, ctaType: btn.type }));
                    _this.interstitialPopupCallback(btn);
                });
                buttons.push(adBtn);
            }
        });
...
export function init_from_snippet() {
    ...
    if (posthog_master['__loaded'] || (posthog_master['config'] && posthog_master['persistence'])) {
        ...
        console.error('Tavas library has already been downloaded at least once.');
        return;
    }
    // Load instances of the Tavas Library
    _each(posthog_master['_i'], function (item) {
        if (item && _isArray(item)) {
            instances[item[2]] = create_mplib.apply(void 0, __spreadArray([], __read(item), false));
        }
    });
