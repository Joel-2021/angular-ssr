 ...
 * Constants
 */
export var SET_QUEUE_KEY = '__mps';
export var SET_ONCE_QUEUE_KEY = '__mpso';
export var UNSET_QUEUE_KEY = '__mpus';
export var ADD_QUEUE_KEY = '__mpa';
export var APPEND_QUEUE_KEY = '__mpap';
export var REMOVE_QUEUE_KEY = '__mpr';
export var UNION_QUEUE_KEY = '__mpu';
