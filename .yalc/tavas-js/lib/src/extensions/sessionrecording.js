...
var SessionRecording = /** @class */ (function () {
    ...
    SessionRecording.prototype.afterDecideResponse = function (response) {
        ...
        if ((_c = response.sessionRecording) === null || _c === void 0 ? void 0 : _c.endpoint) {
            this.endpoint = (_d = response.sessionRecording) === null || _d === void 0 ? void 0 : _d.endpoint;
        }
    ...
    SessionRecording.prototype._updateWindowAndSessionIds = function (event) {
        ...
        if ((this.windowId !== windowId || this.sessionId !== sessionId) &&
    ...
    SessionRecording.prototype._onScriptLoaded = function () {
        ...
        this.stopRrweb = (_b = this.rrwebRecord) === null || _b === void 0 ? void 0 : _b.call(this, __assign({ emit: function (event) {
                event = truncateLargeConsoleLogs(filterDataURLsFromLargeDataObjects(event));
                _this._updateWindowAndSessionIds(event);
                var properties = {
                    $snapshot_data: event,
                    $session_id: _this.sessionId,
                    $window_id: _this.windowId,
                };
                _this.instance._captureMetrics.incr('rrweb-record');
                _this.instance._captureMetrics.incr("rrweb-record-".concat(event.type));
                if (_this.emit) {
                    _this._captureSnapshot(properties);
                }
                else {
                    _this.snapshots.push(properties);
                }
